...
public class PostData extends AsyncTask<Void, Void, String> {
    ...
    public PostData(String urlTo, Map<String, String> args, FileInputStream uploadFileInputStream, String filefield, String fileMimeType, String fileName, Context ctx) {
        this.urlTo = urlTo;
        this.args = args;
